...
const buttonCustom = new Button("Custom", "header_button_custom", "header-button");
const buttonCassettes = new Button("Cassettes", "header_button_cassettes", "header-button");
const buttonCranksets = new Button("Cranksets", "header_button_cranksets", "header-button");
